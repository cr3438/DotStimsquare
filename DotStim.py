...
On each trial the predominant movement of the dots will either be towards the up or the down.
...
COHERENCE_LEVELS = [0.8,0.8,1.0,1.0]  # Fixed coherence levels
    ...
    for direction in DIRECTIONS:
        ...
        for rep in range(0,int(trialn)//10):  
            trial_list.append({
                'coherence': coherence,
                'direction': direction,
                'correct_response': 'down' if direction == 270 else 'up'
            })
